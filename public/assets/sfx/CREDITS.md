...
Clips sourced from Envato Elements via the Envato MCP catalog search.

| File | Item | Author | URL |
| --- | --- | --- | --- |
| `shot.mp3` | Rifle Gunshot | prosoundfx | https://elements.envato.com/rifle-gunshot-NWC5Q9R |
| `sniper.mp3` | Battle Game Weapon Sniper Rifle Gunshot 1 Close Short | Ghetty | https://elements.envato.com/battle-game-weapon-sniper-rifle-gunshot-1-close-sh-BPMZ92U |
| `mg.mp3` | Machine Gun Fires Short Burst | Sound-Ideas | https://elements.envato.com/machine-gun-fires-short-burst-H838T6M |
| `alien.mp3` | Alien Game Weapon Electric Pistol Shot 1 Glitchy Sci Fi Impact Hit Hard Short | Ghetty | https://elements.envato.com/alien-game-weapon-electric-pistol-shot-1-glitchy-s-39GB82B |
| `melee.mp3` | Sword Slash | Diplodo | https://elements.envato.com/sword-slash-3C4BNUD |
| `hit.mp3` | Bullet Hit 17974 | prosoundfx | https://elements.envato.com/bullet-hit-17974-8BE64S5 |
| `ui.mp3` | UI BUTTON Metal Button Spring Click Fast 02 | SmartSoundFX | https://elements.envato.com/ui-button-metal-button-spring-click-fast-02-U4HMZ66 |
| `confirm.mp3` | UI Button Option | Top-Up-Sounds | https://elements.envato.com/ui-button-option-AWDE8HK |
